...
if ( fread(header, 1, bit, file)!=bit ){
...
gluLookAt( x, 1.0f, z,
x+lx, 1.0f, z+lz,
0.0f, 1.0f, 0.0f);///COMPLICATED STUFF MUST CHECK AGAIN
drawGround();
...
cout<< "|| ||     *     ||                                      ||     *     || ||"<<endl;
cout<< "|| ||    ***    || TANVEER MD TANJEEM         17-35663-3||    ***    || ||"<<endl;
cout<< "|| || **********|| IMON, A.N.M. AHSANUL ISLAM 17-35499-3|| **********|| ||"<<endl;
cout<< "|| ||   *****   || KABIR MOSTAKIMUL           17-35673-3||   *****   || ||"<<endl;
cout<< "|| || **********|| SHAILY SHARKER             17-35951-3|| **********|| ||"<<endl;
cout<< "|| ||    ***    ||                                      ||    ***    || ||"<<endl;
cout<< "|| ||     *     ||                                      ||     *     || ||"<<endl;
cout<< "||  /////////////                                        /////////////  ||"<<endl;
cout<< "||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||"<<endl;
